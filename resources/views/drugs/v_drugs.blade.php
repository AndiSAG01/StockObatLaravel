                    ...
                    <tbody>
                        @foreach ($drugs as $no => $ob)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('drugs.edit', $ob->id) }}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-edit"></i></a>
                                    <form id="deleteForm{{ $ob->id }}" class="d-inline"
                                        action="{{ route('drugs.delete', $ob->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button type="button" class="btn btn-danger btn-sm"
                                            onclick="confirmDelete({{ $ob->id }})"><i
