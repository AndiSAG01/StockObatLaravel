...
class DrugsExport implements FromQuery, WithHeadings, WithMapping, WithCustomStartCell, WithTitle, WithEvents
{
    ...
    public function map($drug): array
    {
        return [
            ...
            $drug->id, // or another field that represents 'No'
            $drug->code,
            $drug->date,
            $drug->medicine->kode,
            $drug->medicine->name,
            $drug->transactions->sum('quantity_sell') + $drug->stock,
